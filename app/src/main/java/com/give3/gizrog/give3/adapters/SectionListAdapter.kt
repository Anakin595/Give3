...
class SectionListAdapter(private var activity: Activity, private var items: ArrayList<String>): BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        if (convertView == null) {
            ...
            view = inflater.inflate(R.layout.listitem_section_person, null)
        ...
        sectionViewHolder.txtName?.text = items[position]
    ...
    private class SectionViewHolder(row: View?) {
        var txtName: TextView? = row?.findViewById(R.id.text_listitem_section_person)
